...
import { Clock, Leve, Star } from "../assets/icons";
...
const Carousel = ({ recipe }) => {
  ...
  return (
    <div className="wraper relative flex items-center justify-end">
      <div className="img-recipe absolute left-0 z-50 w-[548px] h-[389.3px]">
        <img
          src="https://www.sidechef.com/recipe/c8738a39-6d2b-4905-a8b7-ad0f0c80311b.jpg"
          alt="recipe"
          className="rounded-[20px] object-cover h-full"
        />
      </div>
      <div className="content-recipe flex flex-col justify-center py-24 px-20  w-[995px] h-[465px] pl-[400px] rounded-[12px] bg-white drop-shadow-2xl">
